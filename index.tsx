...
CRITICAL CONTEXT:
The data shows a 94.3% informal divergence stat. This means 94.3% of cross-border movement in monitored regions bypasses formal Points of Entry (POEs). This is the core of what Phantom POE exists to prove. Keep this context in mind when analyzing corridors.
